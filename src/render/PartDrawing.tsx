      ...
      >
        ...
        >
          ...
          {/*
            ...
            Условие — по самому направлению, а не по наличию подписи: с
            PROMPT 62 подпись есть всегда («без направления» — тоже
            состояние), а стрелка осмысленна только там, где есть куда
            её направить.
          */}
          {view.grain === 'none' ? null : (
