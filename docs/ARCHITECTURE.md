...
3. layout         — рекурсивный обход дерева секций → CellBox[]            план: этап 09
4. dividers       — детали перегородок и полок-разделителей                план: этап 10
5. fill           — полки, ящики, штанги внутри листовых ячеек             план: этап 11
6. back           — деталь задней стенки как отдельный Part                план: этап 13
7. base           — цоколь, ножки                                         план: этап 23
8. countertop     — столешница со свесами                                 план: этап 23
9. facades        — фасады по OverlaySpec                                 план: этап 22
10. edges         — назначение кромки по ролям и сторонам                  план: этап 15
11. drilling      — присадка                                              план: этап 28
```
