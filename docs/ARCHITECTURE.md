...
4. fill           — наполнение ячеек: Content → Parts                      ПОЛКИ РЕАЛИЗОВАНЫ;
                     через resolveContentGeometry (§5.10)                  ящики: этап 21,
                     ящики и штанга дают статус not-implemented            штанга: этап 23
